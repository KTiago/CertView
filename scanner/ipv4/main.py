...
def main(bootstrap_servers):
    while True:
        print("Scan started")
        proc = subprocess.Popen("zmap -r 20000 --sender-threads=3 --cores=0 -p 443 -n 100% -o - | ztee hosts.txt | ./zgrab2 tls -o certificates.txt --gomaxprocs=1 --senders=1000 --blacklist-file=/scanner/ipv4/blacklist.conf", shell=True)
